...
<body>
    ...
    <div class="w3-sidebar w3-bar-block" id="sidebar">
        <ul class="nav side-menu mt-5">
            ...
            <hr>
            <p> Menu </p>
            <a href="far-dashboard.php" class="w3-bar-item w3-button"><i class=""></i><div class="pl">Dashboard</div></a>
            ...
            <a href="far-bantuan.php" class="w3-bar-item w3-button"><i class=""></i></i><div class="pl">Bantuan</div></a>
